...
app.controller("Cart_Controller", function ($scope, $timeout, $rootScope, $window, Cart_Service, FileUploadService) {
    ...
    $scope.selectFileforUpload = function (file) {
        ...
        $scope.Image_Name = files.name;

        alert($scope.Image_Name);
    ...
    $scope.SaveFile = function () {
        ...
        if ($scope.IsFormValid && $scope.IsFileValid) {
            ...
            FileUploadService.UploadFile($scope.SelectedFileForUpload).then(function (d) {
                ...
                var promisePost = Cart_Service.post(ItmDetails);
    ...
    .factory('FileUploadService', function ($http, $q) {
        ...
        fac.UploadFile = function (file) {
            ...
            $http.post("/TeaCart/UploadFile", formData,
